...
public class ExperimentVisualization {
    ...
    public void insertElement(InfoExperiment infoExperiment, int index, Object value) throws InterruptedException{
        ...
        // sets the Box
        int indexArray = this.infoExperiments.indexOf(infoExperiment);
        ...
        VBox vBoxArray = this.layoutExperiment.get(indexArray);
        ...
        for (int i = index+1; i < this.infoExperiments.get(indexArray).getSize()+1; i++){
